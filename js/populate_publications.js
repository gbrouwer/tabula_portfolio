        ...
        for (let i=0;i<text_elements.length-1;i++) {
            ...
            if (text_element.length > 0) {
                ...
                if (text_type_str === "#im") {
                    ...
                    figure_caption.appendChild(figure_name);
                ...
                if (text_type_str === "#tc") {
                    ...
                    if (text !== "empty") {
                        if (text.indexOf("assets/resized_300x450_whiteborder") > -1) {
                ...
                if (text_type_str === "#qc") {
                    ...
                    //cell.style.fontSize = "10pt"
                    if (text !== "empty") {
                        if (text.indexOf("assets/publications") > -1) {
                            let elements = text.split(" ");
                            if (elements.length === 2) {
                                let img = document.createElement("img");
                                img.src = elements[0]
                            ...
                            authors_content = "<qh5>" + authors_content + "</qh5>"
                            title_content = text_elements[1];
                            title_content = "<qh3>" + title_content + "</qh3>"
                            description_content = text_elements[2];
                            if (description_content !== undefined) {
                                description_content = description_content.substring(0,800) + '....'
                            }
